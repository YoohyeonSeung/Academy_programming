...
# 데이터 특성 보기
dim(data) #[1] 300(행)   8(열) 정보 - 차원보기 
length(data) # [1] 8(열의 길이)
length(data$survey) # [1] 300(행)
...
# 2.2 서열척도 기술 통계량
length(data$level) # [1] 297 : 학력수준 - 서열 
