...
# rep() 함수 이용 벡터 객체 생성 
rep(1:3, 3) # replicate : 인자(파라메터):대상, 반복수 
# 결과 : [1] 1 2 3 1 2 3 1 2 3

rep(1:3, each=3)
# 결과 : [1] 1 1 1 2 2 2 3 3 3
...
# Vector 자료 구조 데이터 셋 제공 패키지
install.packages("RSADBE")  # 패키지 다운로드 및 설치
