...
##################################################
## Chapter15_1. 군집 분석(ClusteringAnalysis)
##################################################
...
# single : 트랜잭션 구분자(Transaction ID)에 의해서 상품(item)이 대응된 경우, basket : 여러 개의 상품(item)으로 구성된 경우(Transaction ID 없이 여러 상품으로만 구성된 경우)
