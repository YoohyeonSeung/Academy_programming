...
public class Buyer{
	...
	// 생성자(필드 초기화, 반환형 없으므로 public 할필요 없음, 클래스 이름과 같이!, 같은 폴더내에서는 buyer 옆에 없어도 가능하나, 폴더가 다르면 호출 가능하세 public을 써줘야됨)
	public Buyer(String nameBuyer, int money, int apple ){
		name = nameBuyer;   
		myMoney = money;
		numOfApple = apple;
